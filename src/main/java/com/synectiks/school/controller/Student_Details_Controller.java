...
@GetMapping("get_Fee_Details_by_class")
public List<Map<String, Object>> getFeeDetails1(@RequestParam String clas) throws InterruptedException, ExecutionException {
	System.out.println("#########");
    return feeDetails.getFeeDetails1(clas);
}
...
@GetMapping("attendance_by_class")
public List<Map<String, Object>> getAttendance1(@RequestParam String clas) throws InterruptedException, ExecutionException {
    return attendanceDetails.getAttendance1(clas);
}
